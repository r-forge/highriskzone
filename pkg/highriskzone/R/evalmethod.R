...
#'        Here a Neyman-Scott process is simulated (see \code{\link{sim_nsppp}}, \code{\link[spatstat.random]{rNeymanScott}})
...
#'    
#' @seealso \code{\link{det_hrz}}, \code{\link[spatstat.random]{rNeymanScott}}, \code{\link{thin}}, \code{\link{sim_nsppp}}, \code{\link{sim_intens}}
#' @examples
#' \dontrun{    
#'  data(craterB)
#'  
